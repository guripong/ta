...
//<speak><audio src="https://actions.google.com/sounds/v1/cartoon/slide_whistle.ogg">did not get your audio file</audio></speak>
  var audio1 = `<audio src="https://s3.amazonaws.com/eduai/common/common-003-correct-good.mp3">error</audio>`;
  if (intent == 'Intent_Quiz') {
    if(speech)response = `<speak>hi audio test! number 1. ${audio1} </speak> `;
